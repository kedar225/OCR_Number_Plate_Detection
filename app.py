...
with header :
    ...
    st.write("Introducing our innovative project, spearheaded by Arnav Ambre, Vaibhavi Nakum, Kedar Nadkarni, and Rishi Mishra! We harnessed the power of YOLOv8 to detect license plates seamlessly, and then elevated the user experience by integrating EasyOCR. ")
